...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'heo', // 当前主题默认切到 heo；若 Notion 配置中心存在 THEME，将继续按原优先级覆盖这里的默认值
  ...
  BIO:
    ...
    '面向平台 / 基础设施后端方向成长，关注网关、服务治理、可观测性与稳定性。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-iota-amber-43.vercel.app', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    'gateway, service-discovery, metadata, traffic-governance, observability, reliability, dubbo, opentelemetry', // 网站关键词 英文逗号隔开

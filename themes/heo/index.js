...
const LayoutBase = props => {
  ...
  const contentTabRoutes = new Set([
    '/',
    '/recommended-reading',
    '/recommended-reading/page/[page]',
    '/growth-notes',
    '/growth-notes/page/[page]',
    '/technical-exploration',
    '/technical-exploration/page/[page]',
    '/category',
    '/category/[category]',
        ...
        <section className='mb-4 rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-none dark:border-gray-700 dark:bg-[#202026] md:px-5'>
            <div
              ...
              : readingEntryPanel
                ...
                : ''}`}>
              <div className='order-1 rounded-2xl border border-slate-300 bg-white px-5 py-5 shadow-sm ring-1 ring-slate-100 dark:border-gray-600 dark:bg-[#24232a] dark:ring-white/5 xl:order-2 xl:pl-[4.5rem] xl:pr-6'>
